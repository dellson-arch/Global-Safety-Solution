...
const services = [
  {
    ...
    description: "Statutory testing and certification of lifting equipment, tackles, and pressure vessels following IS and Factory Act standards.",
    category: "TESTING",
    checklist: [
      { question: "Equipment Serial Number", field_type: "TEXT" },
      { question: "Safe Working Load (SWL)", field_type: "NUMBER" },
      { question: "Visual Inspection (Cracks/Deformation)", field_type: "BOOLEAN" },
      { question: "Proof Load Applied (kg)", field_type: "NUMBER" },
      { question: "Condition of Wire Rope/Chain", field_type: "DROPDOWN", options: "Good,Worn,Damaged" },
    ]
  },
  {
    name: "Pressure Vessel Testing (Air Receiver)",
    description: "Professional testing of air receivers and pressure vessels as per Factory Act 1948 Section 31.",
    category: "TESTING",
    checklist: [
      ...
      { question: "Corrosion Assessment", field_type: "DROPDOWN", options: "None,Slight,Heavy" },
    ]
  },
  {
    name: "Building Stability Certification",
    description: "Certified structural stability evaluations for industrial buildings as per Factory Rules.",
  ...
  },
  {
    ...
    description: "Preparation and approval of factory layout maps with Directorate of Factories.",
    category: "LICENSING",
    checklist: [
  ...
  },
  {
    ...
    description: "End-to-end assistance for obtaining or modifying factory licenses.",
    category: "LICENSING",
    checklist: [
  ...
  },
  {
    ...
    description: "Comprehensive third-party safety audits as per DISH guidelines.",
    category: "AUDIT",
    checklist: [
      { question: "Fire Safety Compliance", field_type: "BOOLEAN" },
      { question: "Electrical Safety Status", field_type: "DROPDOWN", options: "Safe,Needs Improvement,Hazardous" },
      { question: "PPE Usage Observed?", field_type: "BOOLEAN" },
      { question: "Safety Training Records Up to Date?", field_type: "BOOLEAN" },
    ]
  },
  {
    name: "Workplace Hygiene Testing (Dust/Noise/Heat/Lux)",
    description: "Professional hygiene testing services as per statutory guidelines.",
    category: "TESTING",
    checklist: [
      { question: "Parameter Type", field_type: "DROPDOWN", options: "Noise,Dust,Illumination,Heat" },
