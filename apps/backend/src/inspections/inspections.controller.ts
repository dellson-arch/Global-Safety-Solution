...
export class InspectionsController {
  ...
  schedule(
    ...
    return this.inspectionsService.scheduleWorkOrder(workOrderId, body.engineerId, body.scheduledDate);
  }
  ...
  @Patch('item/:itemId')
  updateItem(@Param('itemId') itemId: string, @Body() data: UpdateInspectionItemDto) {
    return this.inspectionsService.updateItem(itemId, data);
  }

  @Get(':id/certificate')
  async downloadCertificate(@Param('id') id: string, @Req() req: any, @Res() res: any) {
